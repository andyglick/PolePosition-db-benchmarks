...
public class FlatObjectMonoDBTest {
    ...
    public void updateDoesNotAddObjects() {
        MongoDBHelper.withMongoDBRunning(new OneArgAction<Mongo>() {
            ...
            public void invoke(Mongo mongo) {
                final FlatObjectMongoDB toTest = prepareForTest(mongo);
    ...
    private FlatObjectMongoDB prepareForTest(Mongo mongo) {
        final FlatObjectMongoDB toTest = new FlatObjectMongoDB(ConsistencyOption.NORMAL, mongo);
